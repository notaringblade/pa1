...
<body>
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
    ...
    <div>
        <h1>Add papers</h1>
        <div>
            <form method="POST" action="add_paper_to_student_script.php"> 
            <?php 
                 $username = "root";
                 $password = "";
                ...
                echo "<SELECT name='sid'>";
                 foreach($student as $students){
                    echo "<OPTION value=".$students["sid"] ."> " .$students["st_name"] ."</OPTION>"; 
            ...
            <?php 
                ...
                //  $con = new PDO("mysql:host=localhost;dbname=student_registry", $username, $password );
                 ...
                 foreach($paper as $papers){
                    ...
                    echo "<OPTION value=".$papers["pid"] ."> " .$papers["paper_name"] ."</OPTION>";
                }
                echo "</SELECT>";
                
            ?>
            <div></br></div>
                        <button class="btn btn-dark" name = "enroll" type = "submit"> enroll </button>
